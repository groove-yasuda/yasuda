...
<body>
 ...
 %><br>
		...
		<input type="hidden" name="resID" value=<%=request.getAttribute("kaesiID")%>><br>
		<input type="hidden" name="resNAME"value=<%=request.getAttribute("kaesiNAME")%>>
		<input type="submit" value="確認">

	</form>

	<form action="RETURN13" method="post">
		<br> <input type="hidden" name="hantei" value="0"> <input
